<article class="media status-media">
  <div class="pull-left">
    <img src="{{ $status->user->present()->gravatar(55) }}" alt="{{ $status->user->username }}" class="media-object status-media-object">
    {{-- @include('users.partials.avatar', ['size' => 55, 'user' => $status->user]) --}}
  </div>
